...
namespace CSBatisBuilder {
    ...
    public enum DbVendorId { SQLServer, MySql }
    ...
    public class DaoImplOption : ClassOption {
        ...
        private const String m_DefaultSqlMethodPrefix = "Execute";		
        private const bool m_DefaultUseSqlMapperForSqlMethod = false;
		
        private String m_SqlMapperFmt = m_DefaultSqlMapperFmt;		
        private String m_SqlMethodPrefix = m_DefaultSqlMethodPrefix;				
        private bool m_useSqlMapperForSqlMethod = m_DefaultUseSqlMapperForSqlMethod;
        ...
        [DefaultValue(m_DefaultSqlMethodPrefix)]
        [Description("Customize the way to set the prefix for sql methods, instead of SqlMapperFmt.")]
        public String SqlMethodPrefix {
            get { return m_SqlMethodPrefix; }
            set { m_SqlMethodPrefix = CSHelper.Trim(value, true); }
        }		
		
        [DefaultValue(m_DefaultUseSqlMapperForSqlMethod)]
        [Description("Decide to use prefix or SqlMapperFmt for sql methods calling.")]
        public bool UseSqlMapperForSqlMethod {
            get { return m_useSqlMapperForSqlMethod; }
            set { m_useSqlMapperForSqlMethod = value; }
        }
    ...
    public class DaoMethodSetOption {
        ...
        private DaoMethodOption m_SelectOption = new DaoMethodOption("{0}Select");

        [Description("Gets or sets the options for Select by primary key method.")]
        public DaoMethodOption SelectOption {
            get { return m_SelectOption; }
            set { m_SelectOption = value; }
        }

        #endregion

        #region SelectNonLobOption

        private DaoMethodOption m_SelectNonLobOption = new DaoMethodOption("{0}QuickSelect");

        [Description("Gets or sets the options for SelectNonLob method.")]
        public DaoMethodOption SelectNonLobOption {
            get { return m_SelectNonLobOption; }
            set { m_SelectNonLobOption = value; }
        }

        #endregion

        #region SelectAllOption

        private DaoMethodOption m_SelectAllOption = new DaoMethodOption("{0}SelectAll");

        [Description("Gets or sets the options for SelectAll method.")]
        public DaoMethodOption SelectAllOption {
            get { return m_SelectAllOption; }
            set { m_SelectAllOption = value; }
        }

        #endregion

        #region SelectNonLobAllOption

        private DaoMethodOption m_SelectNonLobAllOption = new DaoMethodOption("{0}QuickSelectAll");

        [Description("Gets or sets the options for SelectNonLobAll method.")]
        public DaoMethodOption SelectNonLobAllOption {
            get { return m_SelectNonLobAllOption; }
            set { m_SelectNonLobAllOption = value; }
        }

        #endregion

        #region SelectByOption

        private DaoMethodOption m_SelectByOption = new DaoMethodOption("{0}SelectBy{1}");

        [Description("Gets or sets the options for SelectBy method.")]
        public DaoMethodOption SelectByOption {
            get { return m_SelectByOption; }
            set { m_SelectByOption = value; }
        }

        #endregion

        #region SelectNonLobByOption

        private DaoMethodOption m_SelectNonLobByOption = new DaoMethodOption("{0}QuickSelectBy{1}");

        [Description("Gets or sets the options for SelectNonLobBy method.")]
        public DaoMethodOption SelectNonLobByOption {
            get { return m_SelectNonLobByOption; }
            set { m_SelectNonLobByOption = value; }
        }
    ...
    #region MySqlDbVendor

    /// <summary><c>MySqlDbVendor</c> implements <see cref="IDbVendor"/> for MySql.</summary>
    public class MySqlDbVendor : IDbVendor {
    ...
    public static class DbVendorProvider {
        ...
        private static readonly MySqlDbVendor m_MySqlDbVendor = new MySqlDbVendor();
        ...
        public static IDbVendor GetVendor(DbVendorId vendorId) {
            switch (vendorId) {
                ...
                case DbVendorId.MySql: return m_MySqlDbVendor;
                default:
    ...
    public class ColumnInfo {
        ...
        private readonly SqlOption m_SqlOption;

        /// <summary>Gets the <see cref="SqlOption"/>.</summary>
        protected SqlOption SqlOption { get { return m_SqlOption; } }
    ...
    public class TableBuilder : ITableBuilderOption {
        ...
        public string SelectMethod {
            get { return String.Format(DaoMethodSetOption.SelectOption.IdFmt, String.Empty); }
        }

        [Category(Categories.DebugInfo)]
        public string SelectNonLobMethod {
            get { return String.Format(DaoMethodSetOption.SelectNonLobOption.IdFmt, String.Empty); }
        }

        [Category(Categories.DebugInfo)]
        public string SelectAllMethod {
            get { return String.Format(DaoMethodSetOption.SelectAllOption.IdFmt, String.Empty); }
        }

        [Category(Categories.DebugInfo)]
        public string SelectNonLobAllMethod {
            get { return String.Format(DaoMethodSetOption.SelectNonLobAllOption.IdFmt, String.Empty); }
        }

        public string SelectByMethod(ColumnInfo column) {
            String name = column.PropName;
            return String.Format(DaoMethodSetOption.SelectByOption.IdFmt, String.Empty, name);
        }

        public string SelectNonLobByMethod(ColumnInfo column) {
            String name = column.PropName;
            return String.Format(DaoMethodSetOption.SelectNonLobByOption.IdFmt, String.Empty, name);
        }
        ...
        public string SelectStmtId {
            get { return String.Format(DaoMethodSetOption.SelectOption.IdFmt, IdBase); }
        }

        [Category(Categories.DebugInfo)]
        public string SelectNonLobStmtId {
            get { return String.Format(DaoMethodSetOption.SelectNonLobOption.IdFmt, IdBase); }
        }

        [Category(Categories.DebugInfo)]
        public string SelectAllStmtId {
            get { return String.Format(DaoMethodSetOption.SelectAllOption.IdFmt, IdBase); }
        }

        [Category(Categories.DebugInfo)]
        public string SelectNonLobAllStmtId {
            get { return String.Format(DaoMethodSetOption.SelectNonLobAllOption.IdFmt, IdBase); }
        }

        public string SelectByStmtId(ColumnInfo column) {
            String name = column.PropName;
            return String.Format(DaoMethodSetOption.SelectByOption.IdFmt, IdBase, name);
        }

        public string SelectNonLobByStmtId(ColumnInfo column) {
            String name = column.PropName;
            return String.Format(DaoMethodSetOption.SelectNonLobByOption.IdFmt, IdBase, name);
        }
    ...
    internal static class CSHelper {
		...
		#region CSharpType & iBatisType convert
		...
		public static string PathRemovePrefix(string pathSrc,string prefix)
		{
			string pathDest = pathSrc.Replace(prefix,string.Empty);
			return pathDest;
		}
		
		public static string SqlMethodString(TableBuilder builder,string method,DaoImplOption daoImplOption)
		{
			string methodString = string.Empty;
			if(daoImplOption.UseSqlMapperForSqlMethod)
			{
				methodString = daoImplOption.SqlMethodPrefix +  builder.SqlMapper + "." + method;
			}
			else
			{
				methodString = daoImplOption.SqlMethodPrefix + method;
			}
